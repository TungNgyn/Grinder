...
public class DexSkills extends Skills{
    public DexSkills(String name, int kraft, int genauigkeit, String mod, ImageIcon bild, String toolText){
        super(name,kraft,genauigkeit,mod,bild,toolText);
    }
    public static DexSkills gezielterSchussSkill = new DexSkills("Gezielter Schuss", 100, 100,"dex",

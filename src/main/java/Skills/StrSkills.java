...
public class StrSkills extends Skills{
    public StrSkills(String name, int kraft, int genauigkeit, String mod, int spKosten, int schlagAnzahl, ImageIcon bild, String toolText){
        super(name,kraft,genauigkeit,mod, spKosten, schlagAnzahl,bild,toolText);
    }

    public static StrSkills angriffSkill = new StrSkills("Angriff", 100, 100,
            "str",0,1,
    ...
    public static StrSkills ansturmSkill = new StrSkills("Ansturm", 150,80,
            "str",5,1,
    ...
    public static StrSkills blitzschlagSkill = new StrSkills("Blitzschlag", 120,90,
            "str",5,2,
    ...
    public static StrSkills stampferSkill = new StrSkills("Stampfer", 60,150,
            "str",5,2,
    ...
    public static StrSkills krueppelnderSchlagSkill = new StrSkills("Krüppelnder Schlag", 200,50,
            "str", 10,3,
